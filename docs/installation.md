...
```bash
# 光流分析
python -m pip install "pixelprobe[flow] @ git+https://github.com/2061863797/PixelProbe.git@v1.0.0"

# Zarr 分块存储
python -m pip install "pixelprobe[storage] @ git+https://github.com/2061863797/PixelProbe.git@v1.0.0"

# MCP 服务
python -m pip install "pixelprobe[mcp] @ git+https://github.com/2061863797/PixelProbe.git@v1.0.0"
```
